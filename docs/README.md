# Documentation The-Walk

Ce dossier centralise la documentation utile pour reprendre le projet, guider le developpement continu et preparer une future soutenance.

La documentation doit rester simple, concrete et alignee avec l'etat reel du repo. Elle ne remplace pas le code, mais donne une vue lisible des choix principaux.
