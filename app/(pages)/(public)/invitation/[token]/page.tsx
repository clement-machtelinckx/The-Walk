                    ...
                    {user ? (
                        <div className="space-y-6 text-center">
                            ...
                            invitation.email.toLowerCase() !== user.email.toLowerCase() ? (
                                <div className="bg-destructive/10 border-destructive/20 text-destructive flex flex-col items-center gap-3 rounded-lg border p-4 text-sm">
                                    <AlertCircle size={20} />
                                    <p className="font-medium">Compte incorrect</p>
                                    <p className="text-xs">
                                        Cette invitation est destinée à{" "}
                                        <span className="font-bold">{invitation.email}</span>. Vous
                                        êtes connecté avec{" "}
