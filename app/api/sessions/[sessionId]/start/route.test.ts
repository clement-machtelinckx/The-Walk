...
describe("POST /api/sessions/[sessionId]/start", () => {
    ...
    type StartedSession = Awaited<ReturnType<typeof SessionService.startSession>>;
    ...
    it("should return 200 and session when start is successful", async () => {
        ...
        vi.mocked(SessionService.startSession).mockResolvedValue(mockSession as StartedSession);
